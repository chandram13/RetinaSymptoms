...
namespace retinaIssues{
    class humanRetina{
        public static void generalSymptoms(string[] args){
        ...
        public static void macularDegeneration(string[] args){
            ...
            symptoms = new Dictionary<string, string>(){DryMD: "A reduction in central vision","A distortion of straight lines in your field of vision","The need for brighter lighting","Difficulty adapting to low lights","Blurriness","Trouble recognizing faces","Retinal damage",WetMD: "A blurry spot in your field of vision","A dark spot in the center of your vision due to blood vessels bleeding or leaking fluid","Hazy vision","Rapidly worsening symptoms"};
